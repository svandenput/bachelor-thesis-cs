...
The security of the ADEM' is defined with \advantage{ADEM',\adversary,\users}{l-miot-ind} = \probabilityblock{L-IND-CCA}{\adversary,\users}{0}{1}, defined by the following game:
\begin{figure}[H]
    \centering
    \begin{pchstack}[boxed,center,space=0.5cm]
