...
\end{align*}
(\textbf{Question: can you start sentences with a sign in a theorem?}).
...
\\\\
To prove this theorem we start by defining game loAE-N2 in figure \ref{fig: loAE-N2 game}. This game is the game loAE-IND-\$-CCA (figure \ref{fig: loAE-IND game}) AE.enc and AE.dec substituted with the N2 calls from figure \ref{fig: N2 calls}.
\begin{figure}[H]
    \begin{pchstack}[boxed,center,space=0.5cm]
