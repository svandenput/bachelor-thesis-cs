...
\backgroundsetup{
   ...
   color=black,
    contents={\begin{tikzpicture}[remember picture, overlay]
      \node at ([yshift=6.07 cm]current page.south)
            {\includegraphics[width = \paperwidth]{images/ruhuisstijl2017-en-169-redslide.pdf}} ;
     \end{tikzpicture}}
 }
...
\maketitleru[
    ...
    others={Mentor:}{Dr Robert Jansen},
    course={Research Proposal},
    title={A Novel Approach to Restore Motor Function in Parkinson's Patients}]

\section*{Abstract}
test \cite{Generalized_Initialization_of_the_Duplex_Construction, Hybrid_Encryption_in_a_Multi-User_Setting, Reconsidering_Generic_Composition}
test2 \cite{abdalla_hybrid_2018, dobraunig_generalized_nodate, hutchison_reconsidering_2014}
\pagenumbering{roman}
\newpage
\tableofcontents
